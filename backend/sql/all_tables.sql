...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('AKTBLKULLANICI') AND name = 'YETKI_SIRKET_AYARLARI')
        ALTER TABLE AKTBLKULLANICI ADD YETKI_SIRKET_AYARLARI BIT DEFAULT 0;

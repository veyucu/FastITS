...
// Type: PtsGonderme.NHLService.PullDatasCompletedEventArgs
...
namespace PtsGonderme.NHLService
{
  ...
  public class PullDatasCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal PullDatasCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
    ...
    public PullResult Result
    {
      get
      {
        ...
        return (PullResult) this.results[0];
      }
    }
  }
}

...
// Type: PtsGonderme.NHLService.PullDatas_CompleteCompletedEventHandler
...
namespace PtsGonderme.NHLService
{
  ...
  public delegate void PullDatas_CompleteCompletedEventHandler(
    object sender,
    PullDatas_CompleteCompletedEventArgs e);
}

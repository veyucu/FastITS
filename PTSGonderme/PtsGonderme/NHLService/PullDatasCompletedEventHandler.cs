...
// Type: PtsGonderme.NHLService.PullDatasCompletedEventHandler
...
namespace PtsGonderme.NHLService
{
  ...
  public delegate void PullDatasCompletedEventHandler(object sender, PullDatasCompletedEventArgs e);
}

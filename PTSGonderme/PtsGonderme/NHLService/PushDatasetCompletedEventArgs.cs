...
// Type: PtsGonderme.NHLService.PushDatasetCompletedEventArgs
...
namespace PtsGonderme.NHLService
{
  ...
  public class PushDatasetCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal PushDatasetCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
    ...
    public PushDataSetResult Result
    {
      get
      {
        this.RaiseExceptionIfNecessary();
        return (PushDataSetResult) this.results[0];
      }
    }
  }
}

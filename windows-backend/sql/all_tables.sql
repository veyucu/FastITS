-- ============================================================================
-- ATAKOD ITS - TÜM TABLOLAR VE VARSAYILAN VERİLER
-- ============================================================================
...
-- ============================================================================
-- Oluşturulma: 2025-12-23
-- Veritabanı: NETSIS
-- ============================================================================

-- ============================================================================
-- 1. KULLANICI TABLOSU (AKTBLKULLANICI)
-- ============================================================================
...
-- ============================================================================
-- 3. PTS MASTER TABLOSU (AKTBLPTSMAS)
-- ============================================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('AKTBLPTSMAS') AND name = 'DURUM')
...
-- ============================================================================
-- 4. PTS TRANSACTION TABLOSU (AKTBLPTSTRA)
-- ============================================================================
...
BEGIN
    ...
    -- Migration: Eksik kolonları ekle
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('AKTBLPTSTRA') AND name = 'DURUM')
...
-- ============================================================================
-- 5. ITS/UTS TAKIP TABLOSU (AKTBLITSUTS)
-- ============================================================================
...
BEGIN
    ...
    CREATE NONCLUSTERED INDEX IX_AKTBLITSUTS_SERI_NO ON AKTBLITSUTS(SERI_NO) INCLUDE (GTIN, DURUM);
    CREATE NONCLUSTERED INDEX IX_AKTBLITSUTS_FATIRS_NO ON AKTBLITSUTS(FATIRS_NO, FTIRSIP) INCLUDE (CARI_KODU);
    CREATE NONCLUSTERED INDEX IX_AKTBLITSUTS_CARI_STOK ON AKTBLITSUTS(CARI_KODU, STOK_KODU) INCLUDE (GTIN, SERI_NO, DURUM);
...
-- ============================================================================
-- 6. ITS MESAJ KODLARI TABLOSU (AKTBLITSMESAJ)
-- ============================================================================
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('TBLFATUIRS') AND name = 'ITS_DURUM')
        ALTER TABLE TBLFATUIRS ADD ITS_DURUM VARCHAR(3) NULL;
    ...
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('TBLFATUIRS') AND name = 'UTS_DURUM')
        ALTER TABLE TBLFATUIRS ADD UTS_DURUM VARCHAR(3) NULL;
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('TBLSIPAMAS') AND name = 'ITS_DURUM')
        ALTER TABLE TBLSIPAMAS ADD ITS_DURUM VARCHAR(3) NULL;
    ...
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('TBLSIPAMAS') AND name = 'UTS_DURUM')
        ALTER TABLE TBLSIPAMAS ADD UTS_DURUM VARCHAR(3) NULL;
